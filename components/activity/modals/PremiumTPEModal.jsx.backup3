...
const TPE_HEIGHT = TPE_WIDTH * 1.6;
...
export const PremiumTPEModal = ({
	...
	const [selectedTip, setSelectedTip] = useState(0); // Pourcentage du pourboire (0, 5, 10, 15)
			...
			>
				...
				>
						...
						>
							...
							{phase === "tip-selection" && (
								<View style={styles.tipSelectionContent}>
									<Text style={styles.tipTitle}>Voulez-vous ajouter un pourboire ?</Text>
									...
									<View style={styles.tipButtonsContainer}>
										{[0, 5, 10, 15].map((percentage) => (
											<TouchableOpacity
												...
												style={[
													styles.tipButton,
													selectedTip === percentage && styles.tipButtonSelected,
												]}
										...
										>
											<Text
												style={[
													...
													selectedTip === percentage && styles.tipButtonTextSelected,
												]}
											>
												{`${percentage}%`}
										</Text>
								...
								<View style={styles.tipPreviewContainer}>
									<View style={styles.tipRow}>
										<Text style={styles.tipLabel}>Sous-total</Text>
										<Text style={styles.tipValue}>{baseAmount.toFixed(2)} €</Text>
									</View>
									{selectedTip > 0 && (
											<View style={styles.tipRow}>
												<Text style={styles.tipLabel}>Pourboire ({selectedTip}%)</Text>
												<Text style={styles.tipValue}>
													{(baseAmount * (selectedTip / 100)).toFixed(2)} €
												</Text>
											</View>
										)}
										<View style={[styles.tipRow, styles.tipRowTotal]}>
											<Text style={styles.tipLabelTotal}>Total</Text>
											<Text style={styles.tipValueTotal}>{finalAmount.toFixed(2)} €</Text>
										</View>
									</View>

								<Text style={styles.tipHint}>Cliquez sur OK ci-dessous pour confirmer</Text>
									...
									{/* Amount */}
									<Text style={styles.amountText}>{finalAmount.toFixed(2)} €</Text>
									<Text style={styles.hintText}>Appuyez sur Payer</Text>
								</View>
							)}
							...
							{phase === "processing" && (
								<View style={styles.processingContent}>
									...
									<Text style={styles.amountSmall}>{finalAmount.toFixed(2)} €</Text>
								</View>
							)}
					...
					<View style={styles.buttonsContainer}>
						...
						{/* Grille numérique (décoratif) */}
						<View style={styles.numpadGrid}>
							{[1, 2, 3, 4, 5, 6, 7, 8, 9, "*", 0, "#"].map((num) => (
								<View key={num} style={styles.numpadKey}>
						...
						<View style={styles.actionRow}>
							...
							<TouchableOpacity
								style={[
									styles.payButton,
									phase !== "idle" && phase !== "tip-selection" && styles.payButtonDisabled,
								]}
								onPress={handlePay}
								disabled={phase !== "idle" && phase !== "tip-selection"}
								activeOpacity={0.7}
