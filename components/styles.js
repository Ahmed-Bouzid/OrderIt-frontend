...
// ── Responsive scale ─────────────────────────────────────────────────────────
// Sur iPhone (<600pt), tout est réduit à 75% pour tenir en portrait.
const IS_PHONE = SCREEN_WIDTH < 600;
const s = (n) => IS_PHONE ? Math.round(n * 0.75) : n;
...
const SPACING = {
	xs: s(4), sm: s(8), md: s(12), lg: s(16), xl: s(20), '2xl': s(24), '3xl': s(32), '4xl': s(40), '5xl': s(48),
};

const RADIUS = {
	sm: s(6), md: s(10), lg: s(14), xl: s(18), '2xl': s(24), full: 9999,
};
...
modalForm: {
width: IS_PHONE ? '96%' : '60%',
maxWidth: IS_PHONE ? undefined : 500,
maxHeight: '90%',
backgroundColor: COLORS.background.elevated,
borderRadius: RADIUS['2xl'],
padding: SPACING['2xl'],
